...
public class FestivalModel {
    ...
    public FestivalModel(String year,String festive_title, String place,  String end_date ,String start_date ,String festive_content_view,String recruitment_truck,int request_truck,String food_category,String deadline,String title_cost) {
        this.year = year;
